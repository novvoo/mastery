 ...
 *
 * - `stripNewLinePrefixes` — opportunistic: strips when the input
 *   clearly carries hashline or diff prefixes, leaves it alone otherwise.
 * - `stripHashlinePrefixes` — strict: only strips when every non-empty
...
/**
 * Single-pass variant of `stripLeadingHashlinePrefixes` that strips at
