...
const TRANSLATIONS = {
  'en': {
    ...
    'chat.continue_round': 'Continue current turn',
    ...
    'msg.hand_to_agent': 'Ask Assistant',
    'msg.hand_to_agent_hint': 'Ask the assistant to analyze this error',
    'msg.copy': 'Copy',
    ...
    'msg.thinking_summary': 'Analyzing context',
    'msg.thinking_in_progress': 'Reasoning',
    'msg.thinking_summary_label': 'Reasoning Overview',
    'msg.iteration_x': 'Iteration {n}',
    'msg.iteration_x_of_y': 'Iteration {n} / {total}',
    'msg.count_messages': '{count} messages',
    'msg.model_thinking': 'Analyzing context',
    ...
    // ===== 执行摘要 =====
    'exec.summary': 'Execution Overview',
    ...
    'exec.ask_revert': 'Prepare revert plan',
    ...
    'inspector.agent_panel': 'Assistant Panel',
    ...
    'common.edit': 'Edit',
	    ...
	    // ===== 管理页面 =====
	    'management.title': 'Management Settings',
	    'management.general': 'General',
	    'management.general_desc': 'Basic agent options, language and theme settings.',
	    'management.models': 'Model Management',
	    'management.models_desc': 'Configure AI model providers and enable/disable specific models.',
	    'management.mcp': 'MCP Management',
	    'management.mcp_desc': 'Manage MCP (Model Context Protocol) server connections.',
	    'management.add_model': 'Add Model',
	    'management.model_config_count': 'configurations',
	    'management.no_models': 'No model configurations yet. Click "+ Add Model" to add one.',
	    'management.not_configured': 'Not configured',
	    'management.enable': 'Enable',
	    'management.disable': 'Disable',
	    'management.enabled': 'Enabled',
	    'management.disabled': 'Disabled',
	    'management.delete_model': 'Delete',
	    'management.delete': 'Delete',
	    'management.model_name_label': 'Display Name',
	    'management.model_field': 'Model Name',
	    'management.search_placeholder': 'Search models by name, model, or provider...',
	    'management.search_result': '{count} of {total} models found',
	    'management.search_no_result': 'No matching models found',
	    'management.mcp_empty': 'No MCP servers configured yet.',
	    'management.mcp_add_server': 'Add Server',
	    'management.mcp_server_name': 'Server Name',
	    'management.mcp_server_type': 'Server Type',
	    'management.mcp_command': 'Command',
	    'management.mcp_args': 'Arguments',
	    'management.mcp_connected': 'Connected',
	    'management.mcp_disconnected': 'Disconnected',
	    'management.mcp_connecting': 'Connecting...',
  ...
  'zh-CN': {
    ...
    'msg.hand_to_agent': '交由助手处理',
    'msg.hand_to_agent_hint': '让助手分析这条错误并提出修复',
    'msg.copy': '复制',
    'msg.copy_hint': '复制内容',
    'msg.details': '详情',
    ...
    'msg.raw_data': '原始数据',
    'msg.thinking_summary': '正在分析上下文',
    'msg.thinking_in_progress': '推理中',
    'msg.thinking_summary_label': '推理概览',
    'msg.iteration_x': '第 {n} 轮',
    'msg.iteration_x_of_y': '第 {n} 轮 / 共 {total} 轮',
    'msg.count_messages': '{count} 条',
    'msg.model_thinking': '正在分析上下文',
    ...
    'common.export': '导出',
	    ...
	    'management.general': '基本设置',
	    'management.general_desc': '基础执行选项、语言和主题设置。',
	    'management.models': '模型管理',
	    'management.models_desc': '配置 AI 模型提供商，启用或禁用特定模型。',
	    'management.mcp': 'MCP管理',
	    'management.mcp_desc': '管理 MCP（Model Context Protocol）服务器连接。',
	    'management.add_model': '添加模型',
	    'management.model_config_count': '个配置',
	    'management.no_models': '暂无模型配置，点击"+ 添加模型"来添加。',
	    'management.not_configured': '未配置',
	    'management.enable': '启用',
	    'management.disable': '禁用',
	    'management.enabled': '已启用',
	    'management.disabled': '已禁用',
	    'management.delete_model': '删除',
	    'management.delete': '删除',
	    'management.model_name_label': '显示名称',
	    'management.model_field': '模型名称',
	    'management.search_placeholder': '按名称、模型或提供商搜索...',
	    'management.search_result': '找到 {count} / {total} 个模型',
	    'management.search_no_result': '没有找到匹配的模型',
	    'management.mcp_empty': '尚未配置 MCP 服务器。',
	    'management.mcp_add_server': '添加服务器',
	    'management.mcp_server_name': '服务器名称',
	    'management.mcp_server_type': '服务器类型',
	    'management.mcp_command': '命令',
	    'management.mcp_args': '参数',
	    'management.mcp_connected': '已连接',
	    'management.mcp_disconnected': '未连接',
	    'management.mcp_connecting': '连接中...',
  ...
  'zh-TW': {
    ...
    'msg.hand_to_agent': '交由助手處理',
    'msg.hand_to_agent_hint': '讓助手分析這則錯誤並提出修復',
    'msg.copy': '複製',
    'msg.copy_hint': '複製內容',
    'msg.details': '詳情',
    ...
    'msg.thinking_summary': '正在分析上下文',
    'msg.thinking_in_progress': '推理中',
    'msg.thinking_summary_label': '推理概覽',
    ...
    'common.close': '關閉',
	    ...
	    // ===== 管理页面 =====
	    'management.title': '管理設定',
	    'management.general': '基本設定',
	    'management.general_desc': '基礎執行選項、語言和主題設定。',
	    'management.models': '模型管理',
	    'management.models_desc': '配置 AI 模型提供商，啟用或停用特定模型。',
	    'management.mcp': 'MCP管理',
	    'management.mcp_desc': '管理 MCP（Model Context Protocol）伺服器連線。',
	    'management.add_model': '新增模型',
	    'management.model_config_count': '個設定',
	    'management.no_models': '尚無模型設定，點選"+ 新增模型"來新增。',
	    'management.not_configured': '未設定',
	    'management.enable': '啟用',
	    'management.disable': '停用',
	    'management.enabled': '已啟用',
	    'management.disabled': '已停用',
	    'management.delete_model': '刪除',
	    'management.delete': '刪除',
	    'management.model_name_label': '顯示名稱',
	    'management.model_field': '模型名稱',
	    'management.search_placeholder': '按名稱、模型或供應商搜尋...',
	    'management.search_result': '找到 {count} / {total} 個模型',
	    'management.search_no_result': '沒有找到匹配的模型',
	    'management.mcp_empty': '尚未設定 MCP 伺服器。',
	    'management.mcp_add_server': '新增伺服器',
	    'management.mcp_server_name': '伺服器名稱',
	    'management.mcp_server_type': '伺服器類型',
	    'management.mcp_command': '指令',
	    'management.mcp_args': '參數',
	    'management.mcp_connected': '已連線',
	    'management.mcp_disconnected': '未連線',
	    'management.mcp_connecting': '連線中...',
	    'management.mcp_connect': '連線',
	    'management.mcp_disconnect': '中斷連線',
	    'management.mcp_tools_count': '{count} 個工具',
	  },
	};
