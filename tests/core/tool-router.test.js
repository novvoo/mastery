...
import { selectToolsForRequest, shouldUseIntentClassifier, PHASE } from '../../src/core/tool-router.js';
...
const ALL_TOOL_NAMES = [
  'read_file', 'list_dir', 'search', 'glob', 'semantic_search', 'web_search', 'web_fetch',
  'write_file', 'edit_file',
  'shell', 'pty_start', 'pty_write', 'pty_read', 'pty_stop',
  'browser_open', 'preview_start', 'preview_stop', 'preview_list',
  'ask_user', 'review', 'verify', 'diagnose', 'brainstorm', 'grill', 'zoom_out', 'architect', 'tdd', 'coverage_check',
  'git_status', 'git_diff', 'git_log', 'git_branch',
  'git_add', 'git_commit', 'git_push', 'git_pull', 'git_stash', 'git_reset',
  'harness_analyze', 'harness_replace', 'harness_insert', 'harness_delete', 'harness_query', 'harness_rollback',
  'to_prd', 'to_issues', 'setup',
  'task_create', 'task_list', 'task_status', 'task_cancel',
  'schedule_create', 'schedule_list', 'schedule_delete', 'schedule_toggle',
  'subagent_spawn', 'subagent_get_result', 'subagent_list', 'subagent_stop', 'subagent_create_nested',
  'mcp_connect', 'mcp_disconnect', 'mcp_list_servers', 'mcp_list_tools', 'mcp_list_resources', 'mcp_call_tool', 'mcp_read_resource', 'mcp_status',
  'caveman', 'handoff',
];
