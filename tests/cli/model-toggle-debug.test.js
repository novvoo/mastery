...
import fs from 'fs';
import { toggleModelConfig, readAllModelConfigs, saveAllModelConfigs } from '../../desktop/main-app/llm-config-and-persistence.js';
...
describe('Model Toggle Sync End-to-End', () => {
  ...
  beforeEach(() => {
    ...
    const initialConfigs = [
      { id: 'model1', provider: 'openai', model: 'gpt-4o', apiKey: 'test-key-123', enabled: false, name: 'OpenAI' },
      { id: 'model2', provider: 'zhipu', model: 'glm-4', apiKey: 'test-key-456', enabled: true, name: '智谱' },
    ];
