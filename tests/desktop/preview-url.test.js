...
describe('desktop preview URL helpers', () => {
  test('normalizes localhost preview addresses', () => {
    ...
    expect(normalizePreviewUrlInput('http://localhost:41730/app?x=1')).toBe(
      'http://localhost:41730/app?x=1',
    );
  });
  ...
  test('formats local preview addresses for compact display', () => {
    expect(formatPreviewUrlInput('http://127.0.0.1:41730/index.html')).toBe(
      '127.0.0.1:41730/index.html',
    );
